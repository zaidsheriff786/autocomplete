...
1. Using shouldComponentUpdate in class based components
...
1. Give 3 examples of the HOC pattern.
...
1. Remove any lifecycle methods:
...
1. Replace this.setState() with useState() Hook:
...
1. Replace this.props with function parameters:

1. Replace this.context with useContext() Hook:
...
1. How to render an HTML string coming from the server.
